...
// netif object fot the Station and Access Point
extern esp_netif_t* esp_netif_sta;
extern esp_netif_t* esp_netif_ap;

/**
 * Messages IDs for the WiFi application task
 * @note Expand this based on tour application requirements
*/
 ...
 * @note Expand this based on tour application requirements e.g. add another type and parameter as required
*/
 ...
 * @note Expand the parameter list based on your requirements e.g. how you've espanded the wifi_app_queue_message_t
*/
